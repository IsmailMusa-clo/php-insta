 ...
 ?>
	...
	<div class="user_details column ">
		...
		<div class="user_details_left_right">
			...
			<br>
			<br>
			<?php echo "منشور: " . $user['num_posts']. "<br>"; 
			echo "لايك: " . $user['num_likes'];
	...
	<div class="main_column column" >
		...
		<form class="post_form" action="index.php" method="POST">
			<textarea name="post_text" id="post_text" placeholder="بماذا تفكر؟"></textarea>
			<input type="submit" name="post" id="post_button" value="نشر">
			<hr>
		</form>
